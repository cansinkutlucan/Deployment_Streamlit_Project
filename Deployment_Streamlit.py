...
# veri setinde binary kategorik değişkenleri seçip tipi integer olmayan number of unique sayısı 2 olanları seçmeliyim
...
import pickle
pickle.dump(rf_model, open('rf_model_new1','wb')) 
